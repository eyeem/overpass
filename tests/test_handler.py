...
def test_handler_delete():
    ...
    namespace_create_call = call('namespace', 'nightly', 'nightly')
    stateful_set_create_call = call('statefulset', 'mysqldb', 'nightly')
    kube_wrapper.delete_k8s_entity.assert_has_calls([namespace_create_call, stateful_set_create_call])
